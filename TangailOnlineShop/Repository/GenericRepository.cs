...
namespace TangailOnlineShop.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        DbSet<Tbl_Entity> _dbSet;

        private MyOnlineShoppingEntities _DBEntity;

        public GenericRepository(MyOnlineShoppingEntities DBEntity)
        {
            _DBEntity = DBEntity;
        ...
        public object GetFirstOrDefault()
        {
